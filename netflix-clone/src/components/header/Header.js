        ...
        <header>
            ...
            <div className="header-content">
                <div className="header-billboard">
                    <img src='https://occ-0-2482-3646.1.nflxso.net/dnm/api/v6/LmEnxtiAuzezXBjYXPuDgfZ4zZQ/AAAABcZdjcnDphK1TiPkNt19wMxyqql90YEzja-IMmQi9UeArdtQC1CC_yNRYPmTUlb6UXo4UlbH9SAPPZWwwzDdVEwmIRwFQCVAwYzcLP2jRu_p.webp?r=e02' alt="billboard"></img>
                </div>
                ...
                <div className="header-buttons">
                    ...
                    <button className="header-button moreInfo-button">
                        <svg
                            width='24'
                            height='24'
                            viewBox='0 0 24 24'
